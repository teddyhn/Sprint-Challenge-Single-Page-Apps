...
> Answer: Prevents page refreshes between components for a more seamless UX. Load times between navigations are much quicker when all data is loaded upfront initially.
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML.
- [ ] What are `controlled components` in React?
> Answer: Elements which have values controlled by React state, changing based on user input.
